...
(0|(?<dirty>.*))\n(0|(?<untracked>.*))(\n(0|(?<behind>.*))\t(0|(?<ahead>.*)))?' \
    ...
    _tide_print_item git $_tide_location_color$tide_git_remote_icon$tide_git_icon' ' (set_color white; echo -ns $location
        set_color $tide_git_color_operation; echo -ns ' '$operation ' '$step/$total_steps
        set_color $tide_git_color_upstream; echo -ns ' ⇣ '$behind ' ⇡ '$ahead
        set_color $tide_git_color_stash; echo -ns ' 󱉰 '$stash
        ...
        set_color $tide_git_color_untracked; echo -ns ' 󰩌 '$untracked)
end
